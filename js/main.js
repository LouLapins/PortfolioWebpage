...
let project2 = new Project("../img/taskbase-desk.png", "../img/taskbase-mob.png", "taskbase", "Task app with Node & Express", "Lets user create, read, update and delete tasks stored in MongoDB.", "https://taskbase.herokuapp.com/");
